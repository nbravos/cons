  ...
  <head>
    ...
    window.onload = function()
    {
      ...
      if (navigator.appVersion.indexOf("Windows NT 6.2") != -1)
        document.head.innerHTML += '<link rel="stylesheet" type="text/css" href="http://aragonltda.cl/pages/css/windows.chrome.fix.css" />'
    }
    </script>
  </head>
      ...
      <div class="row-xs-height">
        <div class="col-xs-height col-middle">
          <div class="error-container text-center">
            ...
            <p>Ingrese al sitio a través de:   <a href="http://aragonltda.cl/login">Iniciar Sesión</a>
            </p>
	     aragonltda.cl--<img alt="" class="m-t-5" data-src="http://aragonltda.cl/pages/img/pagenotfound.png"  height="465"  width="332">-->
