  ...
  <head>
    ...
    window.onload = function()
    {
      ...
      if (navigator.appVersion.indexOf("Windows NT 6.2") != -1)
        document.head.innerHTML += '<link rel="stylesheet" type="text/css" href="https://aragonltda.cl/pages/css/windows.chrome.fix.css" />'
    }
    </script>
  </head>
      ...
      <div class="row-xs-height">
        <div class="col-xs-height col-middle">
          <div class="error-container text-center">
            ...
            <h2 class="semi-bold">Acceso Denegado</h2>
            <p>Ingrese al sitio a través de:   <a href="https://aragonltda.cl/login">Iniciar Sesión</a>
            </p>
	     aragonltda.cl--<img alt="" class="m-t-5" data-src="https://aragonltda.cl/pages/img/pagenotfound.png"  height="465"  width="332">-->
        ...
        <div class="error-container-innner">
          <div class="m-b-30 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
            <div class="col-sm-3 no-padding">
              aragonltda.cl--<img alt="" class="m-t-5" data-src="assets/img/demo/pages_icon.png" data-src-retina="assets/img/demo/pages_icon_2x.png" height="60" src="assets/img/demo/pages_icon.png" width="60"> -->
            </div>
          </div>
        </div>
      </div>
    </div>
    aragonltda.cl-- END PAGE CONTAINER -->
