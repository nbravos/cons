...
@endif
 ...
 <div class="form-group">
    ...
    <input class="form-control" id="fecha_emision" name="fecha_emision" placeholder="DD/MM/AA" value="@if (isset($oc->fecha_emision))
            {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $oc->fecha_emision)->format('d-m-Y') }}
        @endif"type="text">
  </div>  
    <div class="form-group">
    <label class="control-label" for="fecha_entrega">Fecha Entrega</label>
    <input class="form-control" id="fecha_entrega" name="fecha_entrega" placeholder="DD/MM/AA" value="@if (isset($oc->fecha_entrega))
    {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $oc->fecha_entrega)->format('d-m-Y') }}  
        @endif"type="text">
  </div>
      <div class="form-group">
